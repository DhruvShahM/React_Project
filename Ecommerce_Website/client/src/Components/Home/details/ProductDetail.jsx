    ...
    return (
        <>
            ...
            <Typography style={{ marginTop: 5, color: '#878787', fontSize: 14 }}>8 Rating & 1 Reviews
                <Box component="span"><img src={fassured} style={{ width: 77, marginLeft: 20 }} alt="fassure" /></Box>
            </Typography>
            <Typography>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge/>Get extra 20% off (price inclusive of discount) T&C</Typography>
                <Typography><StyledBadge/>Sign up for Flipkart Pay Later and get Flipkart Gift Card worth up to ₹500* Know More</Typography>
                <Typography><StyledBadge/>Buy 2 items save 4%; Buy 3 or more save 5%</Typography>
                <Typography><StyledBadge/>5% Cashback on Flipkart Axis Bank Card</Typography>
                <Typography><StyledBadge/>No cost EMI ₹4,497/month. Standard EMI also available</Typography>
            </SmallText>
            <Table>
                <TableBody>
                    <ColumnText>
